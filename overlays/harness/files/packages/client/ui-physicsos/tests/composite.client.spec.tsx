...
describe('experiment template registry', () => {
  it('exposes at least twenty-three creatable experiments across six domains', () => {
    ...
    expect([...domains].sort()).toEqual(['circuit', 'composite', 'electric', 'magnetic', 'mechanics', 'optics'])
  })
