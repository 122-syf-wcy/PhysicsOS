...
import { asSceneId, asObservableId, asSimulationId, asTraceId, type IsoDateTime } from '@physicsos/shared'
...
function makeBody(id: string, mass: number, position: Vector3, velocity: Vector3, acceleration?: Vector3): Body {
...
export const createMechanicsScene = (input: MechanicsSceneInput): PhysicsScene => {
  ...
  return {
    ...
    bodies: [makeBody(bodyId, mass, position, velocity, acceleration)],
    particles: [],
    fields,
    forces,
    regions: [],
